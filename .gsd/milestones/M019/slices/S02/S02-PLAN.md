...
- [ ] **T02: Implement apply_heal_only helper and wire Heal into apply_effects (Single/SelfOnly)** `est:2 units — helper + resolve_action wiring + apply_effects branch + resolve_targets AllAllies arm.`
...
- [ ] **T03: Wire AllAllies multi-target fan-out in pipeline.rs and add tests/heal_effect.rs** `est:2 units — pipeline fan-out extension + 5 integration test cases.`
