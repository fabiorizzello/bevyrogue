...
- [x] **T02: Add ValidationExt and refactor validation capture to registry-owned blueprint contributors** `est:1.0d`
...
- [x] **T03: Realign CLI and shared-surface proofs to the generic validation contract** `est:0.5d`
