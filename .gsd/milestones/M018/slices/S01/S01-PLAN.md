...
- [x] **T02: DSL + event bus + resolver: split AdvanceTurn/DelayTurn(u32), rimuovi TurnAdvance(i32)** `est:L`
...
- [x] **T03: Pipeline Slowed migration + skills.ron + UI windowed + M017 regression tests** `est:M`
...
- [x] **T04: Boundary test suite: tests/turn_advance_split.rs** `est:M`
...
- [x] **T05: CLI scenario advance-delay-cap + full-suite regression gate** `est:M`
