...
### CAP-a3a59848
**Text:** sp non vengono aumentati quando usa basic attack e ult gauge non sale più di 10(capped a 10 per qualche motivo), in più basic credo debba salirla di 20 e ult di 30
**Captured:** 2026-05-21T21:08:25.713Z
**Status:** resolved
**Classification:** inject
**Resolution:** Inject a new current-slice task to investigate and fix the observed SP/basic gain and ult-gauge cap behavior, including validating the intended +20 basic and +30 ultimate progression rules.
**Rationale:** This is a concrete runtime issue in the active Agumon energy/SP loop and likely requires source plus test updates in the current slice, but it does not by itself require rewriting the whole slice plan.
**Resolved:** 2026-05-21T21:12:00Z
**Milestone:** M002
