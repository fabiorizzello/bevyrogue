...
Generated: 2026-05-18T18:42:36Z | Files: 451 | Described: 0/451
<!-- gsd:codebase-meta {"generatedAt":"2026-05-18T18:42:36Z","fingerprint":"b2fa706e14ea7376cb29e82362560bf02f390fa7","fileCount":451,"truncated":false} -->
...
### doc/check/
- `doc/check/all.html`
- `doc/check/index.html`
- `doc/check/sidebar-items.js`

### doc/search.index/
- `doc/search.index/root.js`

### doc/search.index/alias/
- `doc/search.index/alias/a762150c532c.js`

### doc/search.index/crateNames/
- `doc/search.index/crateNames/d706c1570565.js`

### doc/search.index/desc/
- `doc/search.index/desc/a762150c532c.js`

### doc/search.index/entry/
- `doc/search.index/entry/ef34ca1d9a15.js`

### doc/search.index/function/
- `doc/search.index/function/a762150c532c.js`

### doc/search.index/generic_inverted_index/
- `doc/search.index/generic_inverted_index/a762150c532c.js`

### doc/search.index/name/
- `doc/search.index/name/d706c1570565.js`

### doc/search.index/normalizedName/
- `doc/search.index/normalizedName/d706c1570565.js`

### doc/search.index/path/
- `doc/search.index/path/db24dea89e73.js`

### doc/search.index/type/
- `doc/search.index/type/a762150c532c.js`

### doc/src/check/
- `doc/src/check/null.html`

### doc/static.files/
- `doc/static.files/COPYRIGHT-7fb11f4e.txt`
- `doc/static.files/FiraSans-LICENSE-05ab6dbd.txt`
- `doc/static.files/LICENSE-APACHE-a60eea81.txt`
- `doc/static.files/LICENSE-MIT-23f18e03.txt`
- `doc/static.files/main-5013f961.js`
- `doc/static.files/NanumBarunGothic-LICENSE-a37d393b.txt`
- `doc/static.files/normalize-9960930a.css`
- `doc/static.files/noscript-f7c3ffd8.css`
- `doc/static.files/rustdoc-b7b9f40b.css`
- `doc/static.files/scrape-examples-2bbcccac.js`
- `doc/static.files/search-63369b7b.js`
- `doc/static.files/settings-170eb4bf.js`
- `doc/static.files/SourceCodePro-LICENSE-67f54ca7.txt`
- `doc/static.files/SourceSerif4-LICENSE-a2cfd9d5.md`
- `doc/static.files/src-script-813739b1.js`
- `doc/static.files/storage-41dd4d93.js`
...
### docs/future_design_draft/digimon/agumon/
- `docs/future_design_draft/digimon/agumon/00_identity.md`
- `docs/future_design_draft/digimon/agumon/01_basic_sharp_claws.md`
...
- `docs/future_design_draft/digimon/agumon/04_passive_twin_core_fire.md`
- `docs/future_design_draft/digimon/agumon/README.md`

### docs/future_design_draft/digimon/dorumon/
- `docs/future_design_draft/digimon/dorumon/00_identity.md`
- `docs/future_design_draft/digimon/dorumon/01_basic_bite.md`
- `docs/future_design_draft/digimon/dorumon/02_skill_dash_metal.md`
- `docs/future_design_draft/digimon/dorumon/03_ult_metal_cannon.md`
- `docs/future_design_draft/digimon/dorumon/04_passive_predator_loop.md`

### docs/future_design_draft/digimon/gabumon/
- `docs/future_design_draft/digimon/gabumon/00_identity.md`
- `docs/future_design_draft/digimon/gabumon/01_basic_claw_attack.md`
- `docs/future_design_draft/digimon/gabumon/02_skill_gabumon_shot.md`
- `docs/future_design_draft/digimon/gabumon/03_ult_blue_cyclone.md`
- `docs/future_design_draft/digimon/gabumon/04_passive_fur_cloak.md`

### docs/future_design_draft/digimon/patamon/
- `docs/future_design_draft/digimon/patamon/00_identity.md`
- `docs/future_design_draft/digimon/patamon/01_basic_tai_atari.md`
- `docs/future_design_draft/digimon/patamon/02_skill_patapata_hover.md`
- `docs/future_design_draft/digimon/patamon/03_ult_sparking_air_shot.md`
- `docs/future_design_draft/digimon/patamon/04_passive_holy_aegis.md`

### docs/future_design_draft/digimon/renamon/
- `docs/future_design_draft/digimon/renamon/00_identity.md`
- `docs/future_design_draft/digimon/renamon/01_basic_kokaishu.md`
- `docs/future_design_draft/digimon/renamon/02_skill_koyosetsu.md`
...
### docs/future_design_draft/digimon/tentomon/
- `docs/future_design_draft/digimon/tentomon/00_identity.md`
- `docs/future_design_draft/digimon/tentomon/01_basic_hard_claw.md`
- `docs/future_design_draft/digimon/tentomon/02_skill_petit_thunder.md`
- `docs/future_design_draft/digimon/tentomon/03_ult_electrical_discharge.md`
- `docs/future_design_draft/digimon/tentomon/04_passive_battery_loop.md`

### docs/research/
- `docs/research/sprite_pipeline_evaluation.md`
...
- `tools/sprite_pipeline/.gitignore`
- `tools/sprite_pipeline/AUTO_ITERATION.md`
- `tools/sprite_pipeline/DECISIONS.md`
- `tools/sprite_pipeline/EXTERNAL_TOOLS.md`
- `tools/sprite_pipeline/GETTING_STARTED.md`
- `tools/sprite_pipeline/README.md`

### tools/sprite_pipeline/configs/
- `tools/sprite_pipeline/configs/agumon.example.json`
- `tools/sprite_pipeline/configs/agumon.json`
- `tools/sprite_pipeline/configs/dorumon.json`
- `tools/sprite_pipeline/configs/gabumon.json`
- `tools/sprite_pipeline/configs/patamon.json`
- `tools/sprite_pipeline/configs/renamon.json`
- `tools/sprite_pipeline/configs/tentomon.json`

### tools/sprite_pipeline/palettes/
- `tools/sprite_pipeline/palettes/agumon.gpl`
- `tools/sprite_pipeline/palettes/bevyrogue.gpl`
- `tools/sprite_pipeline/palettes/dorumon.gpl`
- `tools/sprite_pipeline/palettes/gabumon.gpl`
- `tools/sprite_pipeline/palettes/patamon.gpl`
- `tools/sprite_pipeline/palettes/renamon.gpl`
- `tools/sprite_pipeline/palettes/tentomon.gpl`

### tools/sprite_pipeline/plugins/
- `tools/sprite_pipeline/plugins/.gitkeep`
- `tools/sprite_pipeline/plugins/BlenderToPixels.blend`

### tools/sprite_pipeline/plugins/lospec-blender-toolkit/
- `tools/sprite_pipeline/plugins/lospec-blender-toolkit/.gitignore`
- `tools/sprite_pipeline/plugins/lospec-blender-toolkit/Lospec_Blender_Toolkit.blend`
- `tools/sprite_pipeline/plugins/lospec-blender-toolkit/README.md`

### tools/sprite_pipeline/raw_models/
- `tools/sprite_pipeline/raw_models/.gitkeep`

### tools/sprite_pipeline/raw_models/agumon/
- `tools/sprite_pipeline/raw_models/agumon/chr050.fbx`

### tools/sprite_pipeline/raw_models/dorumon/
- `tools/sprite_pipeline/raw_models/dorumon/chr112.fbx`

### tools/sprite_pipeline/raw_models/gabumon/
- `tools/sprite_pipeline/raw_models/gabumon/chr151.fbx`

### tools/sprite_pipeline/raw_models/patamon/
- `tools/sprite_pipeline/raw_models/patamon/chr096.fbx`

### tools/sprite_pipeline/raw_models/renamon/
- `tools/sprite_pipeline/raw_models/renamon/chr391.glb`

### tools/sprite_pipeline/raw_models/tentomon/
- `tools/sprite_pipeline/raw_models/tentomon/chr303.fbx`

### tools/sprite_pipeline/references/patamon/
- `tools/sprite_pipeline/references/patamon/patamon.webp`

### tools/sprite_pipeline/references/tentomon/
...
- `tools/sprite_pipeline/scripts/shaders/anime_eevee.py`
- `tools/sprite_pipeline/scripts/shaders/mihoyo_style.py`

### tools/sprite_pipeline/standards/
- `tools/sprite_pipeline/standards/agumon.md`
- `tools/sprite_pipeline/standards/dorumon.md`
- `tools/sprite_pipeline/standards/gabumon.md`
- `tools/sprite_pipeline/standards/global.md`
- `tools/sprite_pipeline/standards/patamon.md`
- `tools/sprite_pipeline/standards/renamon.md`
- `tools/sprite_pipeline/standards/tentomon.md`
