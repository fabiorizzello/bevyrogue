use bevyrogue::{combat::api::{register_kernel_builtins, ExtRegistries}, data::{skill_timeline::compile_skill_book_timelines, skills_ron::{SkillBook, validate_skill_book}}};
...
fn inspect() {
    ...
    for t in compiled { println!("{}", t.id); }
}
