...
fn parse_valid_graph() -> AnimGraph {
    ron::from_str(include_str!("../assets/test/animation_validation/valid_anim_graph.ron"))
        .expect("valid_anim_graph.ron should parse")
}

fn parse_broken_graph() -> AnimGraph {
    ron::from_str(include_str!("../assets/test/animation_validation/broken_anim_graph.ron"))
...
fn full_catalog() -> AnimationValidationCatalogs {
    ...
    catalogs.particles.insert(ParticleId("impact_particle".into()));
