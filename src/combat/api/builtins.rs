...
fn always_true(_: &BeatEvent, _: &crate::combat::api::SkillCtx<'_>) -> bool {
    true
}

fn always_false(_: &BeatEvent, _: &crate::combat::api::SkillCtx<'_>) -> bool {
    false
}
...
fn delay_turn(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
...
fn advance_turn(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
...
fn revive(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
...
fn grant_free_skill(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
...
fn grant_energy(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
...
fn self_advance(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
...
fn apply_effect(evt: &BeatEvent, ctx: &mut crate::combat::api::SkillCtx<'_>) {
