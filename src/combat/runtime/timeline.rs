...
mod tests {
    use super::*;
    use crate::combat::runtime::registry::ExtRegistries;
    ...
    fn populated_regs() -> ExtRegistries {
        fn noop_hook(_: &BeatEvent, _: &mut crate::combat::runtime::skill_ctx::SkillCtx<'_>) {}
        fn noop_selector(_: &SelectorCtx<'_>) -> Vec<UnitId> {
            vec![]
        }
        fn noop_pred(_: &BeatEvent, _: &crate::combat::runtime::skill_ctx::SkillCtx<'_>) -> bool {
            false
        }
