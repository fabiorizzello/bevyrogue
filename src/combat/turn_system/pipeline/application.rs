...
use crate::combat::resolution::{
    ...
    resolve_targets, select_bounce_hop, TargetEntry, TargetableSnapshot,
};
...
use crate::data::skills_ron::{DamageCurve, RepeatPolicy, TargetShape};
use std::collections::HashSet;

use super::super::{ResolveActorsQuery, emit_combat_beat, emit_combat_event, emit_kernel_transition, set_phase};
